...
public partial class MainApp : System.Windows.Application
{
    ...
    {
        if (Current is not MainApp app || app._serviceProvider is null)
        ...
        try
        {
            ...
            try
            {
                cfg = new ConfigurationBuilder()
                    ...
                    .AddUserSecrets<MainApp>(optional: true, reloadOnChange: false)
            ...
            var logger = _serviceProvider.GetRequiredService<ILogger<MainApp>>();
